...
% Example usage:
% Verify under-sampling (fs > 2fm)
verifySamplingTheorem(10, 3);

% Verify Nyquist sampling (fs = 2fm)
verifySamplingTheorem(10, 2);

% Verify over-sampling (fs < 2fm)
verifySamplingTheorem(10, 1.5);
